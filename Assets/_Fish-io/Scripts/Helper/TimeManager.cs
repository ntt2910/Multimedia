...
public class TimeManager
{
    ...
    /// <summary>
    /// return datetime co dang 8h25m40s
    /// </summary>
    /// <param name="seconds"></param>
    /// <returns></returns>
    public static string ShowHourMinuteSecondTime(float seconds)
    {
        var num = (int)seconds / 3600;
        var num2 = (int)seconds % 3600 / 60;
        var num3 = (int)seconds % 60;
        if (num > 0)
        {
            return num2 > 0 ? $"{num}h{num2:00}m{num3:00}s" : $"{num}h";
        }
        if (num2 > 0)
        {
            return num3 > 0 ? num2 + "m" + num3.ToString("00") + "s" : num2 + "m";
        }
        return num3 + "s";
        //return num3.ToString("00") + "s";
    }
    ...
    /// <summary>
    /// return datetime co dang 8h25m
    /// </summary>
    /// <param name="mins"></param>
    /// <returns></returns>
    public static string ShowHourMinuteTime(long mins)
    {
        var num = mins / 60;
        var num2 = mins % 60;
        //long num3 = seconds % 60;
        if (num > 0)
        {
            return num2 > 0 ? $"{num}h{num2}m" : $"{num}h";
        }
        else
        {
