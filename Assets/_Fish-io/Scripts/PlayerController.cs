...
public class PlayerController : Fish
{
    ...
    protected override void Update()
    {
        ...
        // Vector3 currentSize = fishSkin.sword.GetCurrentGraphic().size;
        // if (axis.y != 0)
        // {
        //     
        //     fishSkin.sword.GetCurrentGraphic().size = new Vector3(currentSize.x, 0.6f, currentSize.z);
        // }
        // else
        // {
        //     
        //     fishSkin.sword.GetCurrentGraphic().size = new Vector3(currentSize.x, 6, currentSize.z);
        // }
    ...
    public override void Die()
    {
        ...
        if (isReincarnation)
        {
            ...
            isRecive = true;
            GameController.instance.musicManager.PlayOneShot(GameController.instance.soundData.ReincarnationCast);
            DelayAction(3f, () =>
            {
                isRecive = false;
                isPlay = true;
    ...
    public override void TakeDamage(int damage)
    {
        ...
        SlowmotionManager.Instance.slowdownLength = 2.5f;
    ...
    public override void ChangeKillAmount(int _kill)
    {
        //if(killAmount == 0) GameController.instance.musicManager.PlayOneShot(GameController.instance.soundData.FirstBlood);
        base.ChangeKillAmount(_kill);
    }
}
