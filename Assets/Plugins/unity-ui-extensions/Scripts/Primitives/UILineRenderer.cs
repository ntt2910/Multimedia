...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UILineRenderer : UIPrimitiveBase
    {
        ...
        private static readonly Vector2[] middleUvs = new[] { UV_TOP_LEFT, UV_BOTTOM_LEFT, UV_BOTTOM_RIGHT, UV_TOP_RIGHT };
        ...
        {
            base.Awake();
            m_points = new Vector2[listLevel.Length];
            for (int i = 0; i < listLevel.Length; i++)
            {
                m_points[i] = listLevel[i].anchoredPosition;
            }
        }
        */
        /// <summary>
