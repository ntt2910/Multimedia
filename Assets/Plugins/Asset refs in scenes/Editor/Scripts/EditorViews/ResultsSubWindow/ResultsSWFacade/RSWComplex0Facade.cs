...
{
    public class RSWComplex0Facade : ResultsSWFacade, IOriginator<RSWComplex0Facade.Memento>
    {      
        #region subsystems
        private RSWComplex0Alg swAlg;
        #endregion
        ...
        public void ReCreate(string title, string headerData, List<string> contentTitles, List<DataGOPath[]> contentData)
        {
            ...
            swAlgoritm = swAlg = new RSWComplex0Alg(headerData, contentData2, dataFoldout, uiActions);
        ...
        {
            public RSWComplex0Alg.Memento swAlg;
