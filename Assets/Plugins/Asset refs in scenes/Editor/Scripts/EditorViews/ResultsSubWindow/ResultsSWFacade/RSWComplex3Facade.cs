...
{
    public class RSWComplex3Facade : ResultsSWFacade, IOriginator<RSWComplex3Facade.Memento>
    {
        #region subsystems
        private RSWComplex3Alg swAlg;
        #endregion
        ...
        public void ReCreate(string title, string headerData, List<string> contentTitles, List<DataGOPath[]> contentData)
        {
            ...
            swAlgoritm = swAlg = new RSWComplex3Alg(headerData, contentData2, dataFoldout, uiActions);
        ...
        {
            public RSWComplex3Alg.Memento swAlg;
