...
{
    public class RSWComplex2Facade : ResultsSWFacade, IOriginator<RSWComplex2Facade.Memento>
    {
        #region subsystems
        private RSWComplex2Alg swAlg;
        #endregion
        ...
        public void ReCreate(string title, string headerData, List<string> contentTitles, List<DataGOPath[]> contentData)
        {
            ...
            swAlgoritm = swAlg = new RSWComplex2Alg(headerData, contentData2, dataFoldout, uiActions);
        ...
        {
            public RSWComplex2Alg.Memento swAlg;
