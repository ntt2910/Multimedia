...
namespace Com.LuisPedroFonseca.ProCamera2D
{
    ...
    public class Room
    {
        ...
        [Range(0f, 10f)] public float TransitionDuration;

        public EaseType TransitionEaseType;
        public bool ScaleCameraToFit;
        public bool Zoom;

        [Range(0.1f, 10f)] public float ZoomScale;
    ...
    public class ProCamera2DRooms : BasePC2D, IPositionOverrider, ISizeOverrider
    {
        ...
        void TransitionToRoom(Room room, bool useTransition = true)
        {
            ...
            _transitionRoutine = StartCoroutine(TransitionRoutine(numericBoundariesSettings, targetSize, useTransition ? room.TransitionDuration : 0f,
                room.TransitionEaseType));
        }

        IEnumerator TransitionRoutine(NumericBoundariesSettings numericBoundariesSettings, float targetSize, float transitionDuration = 1f,
