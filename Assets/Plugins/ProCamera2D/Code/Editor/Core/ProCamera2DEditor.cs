...
namespace Com.LuisPedroFonseca.ProCamera2D
{
    ...
    public class ProCamera2DEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            _tooltip = new GUIContent("Camera Smooth Speed", "How smooth the camera move?");
            EditorGUILayout.PropertyField(serializedObject.FindProperty("CameraMovementSmoothSpeed"), _tooltip);
