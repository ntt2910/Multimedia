...
namespace BW.Inspector
{
	...
	[CustomPropertyDrawer(typeof(SceneSelectionAttributeAttribute))]
	public class SceneAttributeDrawer : SceneDrawer {

		SceneSelectionAttributeAttribute sceneAttribute { get { return ((SceneSelectionAttributeAttribute)attribute); } }
